...
function Courses() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      fetch(`${API_BASE_URL}/categories/`).then((res) => res.json()).catch(() => []),
    ])
  ...
  const filteredCourses = courses.filter((course) => {
    ...
    const matchesCategory = selectedCategory === "All" || course.category === Number(selectedCategory);
  ...
  return (
    <div className="container page-padding">
      <div className="catalog-header">
        ...
        <p className="subtitle">Discover world-class video courses taught by industry experts</p>
          ...
          {filteredCourses.map((course) => (
            <div key={course.id} className="course-card">
              ...
              <div className="card-body">
                ...
                <p className="card-desc">{(course.description || "").substring(0, 100)}...</p>
                ...
                <div className="card-footer-row">
                  ...
                  <Link to={`/courses/${course.id}`} className="btn-primary sm">
                    View Course
                  </Link>
                </div>
              </div>
